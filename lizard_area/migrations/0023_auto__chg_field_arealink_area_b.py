...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AreaLink.area_b'
        db.alter_column('lizard_area_arealink', 'area_b_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_area.Area']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AreaLink.area_b'
        raise RuntimeError("Cannot reverse this migration. 'AreaLink.area_b' and its values cannot be restored.")
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 9, 20, 42, 51, 531180)'}),
        ...
        'lizard_area.arealink': {
            ...
            'area_b': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'arealink_b'", 'null': 'True', 'to': "orm['lizard_area.Area']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lizard_area.areawfsconfiguration': {
            ...
            'cql_filter': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
