...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AreaWFSConfiguration.cql_filter'
        db.alter_column('lizard_area_areawfsconfiguration', 'cql_filter', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Changing field 'AreaWFSConfiguration.cql_filter'
        db.alter_column('lizard_area_areawfsconfiguration', 'cql_filter', self.gf('django.db.models.fields.CharField')(default=datetime.date(2012, 3, 19), max_length=50))
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 19, 0, 3, 49, 860996)'}),
