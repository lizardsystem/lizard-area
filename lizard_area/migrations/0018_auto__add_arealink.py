...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_area_arealink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area_a', self.gf('django.db.models.fields.related.ForeignKey')(related_name='arealink_a', to=orm['lizard_area.Area'])),
            ('area_b', self.gf('django.db.models.fields.related.ForeignKey')(related_name='arealink_b', to=orm['lizard_area.Area'])),
            ('link_type', self.gf('django.db.models.fields.CharField')(default='', max_length=24, null=True, blank=True)),
        ))
        db.send_create_signal('lizard_area', ['AreaLink'])


    def backwards(self, orm):
        
        # Deleting model 'AreaLink'
        db.delete_table('lizard_area_arealink')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 9, 10, 37, 44, 710510)'}),
