...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AreaWFSConfiguration.path'
        db.add_column('lizard_area_areawfsconfiguration', 'path', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AreaWFSConfiguration.path'
        db.delete_column('lizard_area_areawfsconfiguration', 'path')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 18, 23, 48, 11, 426402)'}),
