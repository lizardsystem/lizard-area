...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Communique.dt_latestchanged_krw'
        db.alter_column('lizard_area_communique', 'dt_latestchanged_krw', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Area.dt_created'
        db.alter_column('lizard_area_area', 'dt_created', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Area.dt_latestsynchronized'
        db.alter_column('lizard_area_area', 'dt_latestsynchronized', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Area.dt_latestchanged'
        db.alter_column('lizard_area_area', 'dt_latestchanged', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Communique.dt_latestchanged_krw'
        db.alter_column('lizard_area_communique', 'dt_latestchanged_krw', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Area.dt_created'
        db.alter_column('lizard_area_area', 'dt_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Area.dt_latestsynchronized'
        db.alter_column('lizard_area_area', 'dt_latestsynchronized', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Area.dt_latestchanged'
        db.alter_column('lizard_area_area', 'dt_latestchanged', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 30, 13, 31, 13, 952401)'}),
