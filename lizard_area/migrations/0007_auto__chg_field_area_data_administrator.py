...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Area.data_administrator'
        db.alter_column('lizard_area_area', 'data_administrator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_area.DataAdministrator'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Area.data_administrator'
        db.alter_column('lizard_area_area', 'data_administrator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lizard_area.DataAdministrator']))
