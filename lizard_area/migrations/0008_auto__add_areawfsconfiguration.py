...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AreaWFSConfiguration'
        db.create_table('lizard_area_areawfsconfiguration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('area_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('typeName', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('cql_filter', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('data_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataSet'])),
        ))
        db.send_create_signal('lizard_area', ['AreaWFSConfiguration'])


    def backwards(self, orm):
        
        # Deleting model 'AreaWFSConfiguration'
        db.delete_table('lizard_area_areawfsconfiguration')
