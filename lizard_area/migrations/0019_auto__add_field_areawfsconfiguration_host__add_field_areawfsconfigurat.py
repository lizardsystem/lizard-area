...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AreaWFSConfiguration.host'
        db.add_column('lizard_area_areawfsconfiguration', 'host', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'AreaWFSConfiguration.url'
        db.add_column('lizard_area_areawfsconfiguration', 'url', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'AreaWFSConfiguration.username'
        db.add_column('lizard_area_areawfsconfiguration', 'username', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'AreaWFSConfiguration.password'
        db.add_column('lizard_area_areawfsconfiguration', 'password', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AreaWFSConfiguration.host'
        db.delete_column('lizard_area_areawfsconfiguration', 'host')

        # Deleting field 'AreaWFSConfiguration.url'
        db.delete_column('lizard_area_areawfsconfiguration', 'url')

        # Deleting field 'AreaWFSConfiguration.username'
        db.delete_column('lizard_area_areawfsconfiguration', 'username')

        # Deleting field 'AreaWFSConfiguration.password'
        db.delete_column('lizard_area_areawfsconfiguration', 'password')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 18, 22, 31, 28, 825607)'}),
        ...
        'lizard_area.arealink': {
            'Meta': {'object_name': 'AreaLink'},
            'area_a': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'arealink_a'", 'to': "orm['lizard_area.Area']"}),
            'area_b': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'arealink_b'", 'to': "orm['lizard_area.Area']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '24', 'null': 'True', 'blank': 'True'})
        },
        'lizard_area.areawfsconfiguration': {
            ...
            'host': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lizard_area.synchronizationhistory': {
            'Meta': {'ordering': "['-dt_start']", 'object_name': 'SynchronizationHistory'},
