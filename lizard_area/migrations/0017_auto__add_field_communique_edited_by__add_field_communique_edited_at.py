...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Communique.edited_by'
        db.add_column('lizard_area_communique', 'edited_by', self.gf('django.db.models.fields.TextField')(max_length=150, null=True, blank=True), keep_default=False)

        # Adding field 'Communique.edited_at'
        db.add_column('lizard_area_communique', 'edited_at', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Communique.edited_by'
        db.delete_column('lizard_area_communique', 'edited_by')

        # Deleting field 'Communique.edited_at'
        db.delete_column('lizard_area_communique', 'edited_at')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 1, 17, 22, 9, 965474)'}),
