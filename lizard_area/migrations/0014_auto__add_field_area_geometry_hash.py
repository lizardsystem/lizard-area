...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Area.geometry_hash'
        db.add_column('lizard_area_area', 'geometry_hash', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Area.geometry_hash'
        db.delete_column('lizard_area_area', 'geometry_hash')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 30, 22, 29, 46, 744139)'}),
