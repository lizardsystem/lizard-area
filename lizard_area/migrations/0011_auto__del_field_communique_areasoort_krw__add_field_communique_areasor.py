...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Communique.areasort_krw'
        db.add_column('lizard_area_communique', 'areasort_krw', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Communique.areasort_krw'
        db.delete_column('lizard_area_communique', 'areasort_krw')
