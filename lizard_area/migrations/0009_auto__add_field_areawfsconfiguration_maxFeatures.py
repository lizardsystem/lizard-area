...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AreaWFSConfiguration.maxFeatures'
        db.add_column('lizard_area_areawfsconfiguration', 'maxFeatures', self.gf('django.db.models.fields.IntegerField')(default=64000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AreaWFSConfiguration.maxFeatures'
        db.delete_column('lizard_area_areawfsconfiguration', 'maxFeatures')
