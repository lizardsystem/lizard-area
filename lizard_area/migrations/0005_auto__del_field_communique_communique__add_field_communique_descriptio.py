...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Communique.description'
        db.add_column('lizard_area_communique', 'description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Communique.description'
        db.delete_column('lizard_area_communique', 'description')
